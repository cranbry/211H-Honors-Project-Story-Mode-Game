...
struct qt_meta_stringdata_CLASSDialogueBoxENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDialogueBoxENDCLASS = QtMocHelpers::stringData(
    "DialogueBox",
    "dialogueFinished",
    "",
    "choiceSelected",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDialogueBoxENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DialogueBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSDialogueBoxENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDialogueBoxENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDialogueBoxENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void DialogueBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DialogueBox *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (DialogueBox::*)();
            if (_t _q_method = &DialogueBox::dialogueFinished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *DialogueBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDialogueBoxENDCLASS.stringdata0))
